""" imagezmq-git: Transport OpenCV images via ZMQ.
...
computer for displaying the images using cv2.imshow() or for further images
...
class ImageSender():
    ...
    Opens a zmq REQ socket on the images sending computer, often a
    ...
    def send_image(self, msg, image):
        """Sends OpenCV images and msg to hub computer.

        Arguments:
          msg: text message or images name.
          image: OpenCV images to send to hub.
        ...
        if image.flags['C_CONTIGUOUS']:
            # if images is already contiguous in memory just send it
    ...
    def send_jpg(self, msg, jpg_buffer):
        ...
        Arguments:
          msg: images name or message text.
          jpg_buffer: bytestring containing the jpg images to send to hub.
        Returns:
          A text reply from hub.
        """
...
class ImageHub():
    ...
    def recv_image(self, copy=False):
        """Receives OpenCV images and text msg.

        Arguments:
          copy: (optional) zmq copy flag.

        Returns:
          msg: text msg, often the images name.
          image: OpenCV images.
        """
    ...
    def recv_jpg(self, copy=False):
        ...
        Arguments:
          copy: (optional) zmq copy flag
        Returns:
          msg: text message, often images name
          jpg_buffer: bytestring jpg compressed images
        """
...
class SerializingSocket(zmq.Socket):
    ...
    def send_array(self, A, msg='NoName', flags=0, copy=True, track=False):
        ...
        Arguments:
          A: numpy array or OpenCV images.
          msg: (optional) array name, images name or text message.
    ...
    def send_jpg(self,
        ...
        Sends a jpg bytestring of an OpenCV images.
        Also sends text msg, often the images name.

        Arguments:
          msg: images name or text message.
          jpg_buffer: jpg buffer of compressed images to be sent.
          flags: (optional) zmq flags.
          copy: (optional) zmq copy flag.
          track: (optional) zmq track flag.
        """
    ...
    def recv_array(self, flags=0, copy=True, track=False):
        ...
        Returns the array and a text msg, often the array or images name.
        ...
        Returns:
          msg: images name or text message.
          A: numpy array or OpenCV images reconstructed with dtype and shape.
        """
    ...
    def recv_jpg(self, flags=0, copy=True, track=False):
        ...
        Receives a jpg bytestring of an OpenCV images.
        Also receives a text msg, often the images name.
        ...
        Returns:
          msg: images name or text message.
          jpg_buffer: bytestring, containing jpg images.
        """
